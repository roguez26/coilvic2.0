...
public class CollaborativeProjectFeedbackController implements Initializable {
    ...
    private boolean questionsHasBeenAnswered() {
        ...
        if (responsesList == null || responsesList.isEmpty()) {
            ...
            areAnswered = cont == responsesList.size();
        }
        return areAnswered;
    }
    ...
    private void handleDAOException(DAOException exception) {
        try {
            ...
            Log.getLogger(CollaborativeProjectFeedbackController.class).error(ioException.getMessage(),
                    ioException);
        }
    }
    ...
    private void changeToCollaborativeProjectDetailsStudent() {
        ...
        try {
            ...
            Log.getLogger(CollaborativeProjectFeedbackController.class).error(exception.getMessage(),
                    exception);
        }
    }
