...
public class UniversityRegistrationController implements Initializable {
    ...
    private void goBack() {
        try {
            ...
            Log.getLogger(UniversityRegistrationController.class).error(exception.getMessage(),
                    exception);
        }
    }
    ...
    private void handleDAOException(DAOException exception) {
        try {
            ...
            Log.getLogger(UniversityRegistrationController.class).error(ioException.getMessage(), ioException);
        }
    }
