...
public class ProfessorNotificationController implements Initializable {
    ...
    private void handleDAOException(DAOException exception) {
        try {
            ...
            Log.getLogger(ProfessorNotificationController.class).error(ioException.getMessage(), ioException);
        }
    }
