...
public class StudentRegistrationController implements Initializable {
    ...
    void cancelButtonIsPressed(ActionEvent event) {
        if (confirmCancelation()) {
            try {
                ...
                Log.getLogger(StudentRegistrationController.class).error(exception.getMessage(), exception);
            }
        }
    }
    ...
    private void handleDAOException(DAOException exception) {
        try {
            ...
            Log.getLogger(StudentRegistrationController.class).error(ioException.getMessage(), ioException);
        }
    }
