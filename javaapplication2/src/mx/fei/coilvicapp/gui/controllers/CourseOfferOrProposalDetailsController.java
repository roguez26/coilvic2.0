...
public class CourseOfferOrProposalDetailsController implements Initializable {
    ...
    private boolean wasRejectedConfirmation() {
        ...
        ("Curso rechazado","Se rechazo el curso con éxito");
        return response.get() == DialogController.BUTTON_ACCEPT;
    }
    
    private boolean wasAcceptedConfirmation() {
        Optional<ButtonType> response = DialogController.getInformativeConfirmationDialog
        ("Curso aceptado","Se acepto el curso con éxito");
        return response.get() == DialogController.BUTTON_ACCEPT;
    }
    
    private boolean emptyComboBoxConfirmation() {
        Optional<ButtonType> response = DialogController.getInformativeConfirmationDialog
        ("Alerta","Seleccione un curso para enviar solicitud");
        return response.get() == DialogController.BUTTON_ACCEPT;
    }
    
    private boolean collaborativeProjectRequestConfirmationSent() {
        Optional<ButtonType> response = DialogController.getInformativeConfirmationDialog
        ("Solicitud enviada","Se envio la solicitud con exito");
        return response.get() == DialogController.BUTTON_ACCEPT;
    }
